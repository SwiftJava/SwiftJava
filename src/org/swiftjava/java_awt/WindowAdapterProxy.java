...
public class WindowAdapterProxy extends java.awt.event.WindowAdapter {
    ...
    boolean entered_windowActivated_3;

    public void windowActivated( java.awt.event.WindowEvent e ) {
        if ( !entered_windowActivated_3 ) {
            entered_windowActivated_3 = true;
            __windowActivated( __swiftObject, e);
            entered_windowActivated_3 = false;
        }
        else
    ...
    boolean entered_windowClosed_4;

    public void windowClosed( java.awt.event.WindowEvent e ) {
        if ( !entered_windowClosed_4 ) {
            entered_windowClosed_4 = true;
            __windowClosed( __swiftObject, e);
            entered_windowClosed_4 = false;
        }
        else
    ...
    boolean entered_windowClosing_5;

    public void windowClosing( java.awt.event.WindowEvent e ) {
        if ( !entered_windowClosing_5 ) {
            entered_windowClosing_5 = true;
            __windowClosing( __swiftObject, e);
            entered_windowClosing_5 = false;
        }
        else
    ...
    boolean entered_windowDeiconified_7;

    public void windowDeiconified( java.awt.event.WindowEvent e ) {
        if ( !entered_windowDeiconified_7 ) {
            entered_windowDeiconified_7 = true;
            __windowDeiconified( __swiftObject, e);
            entered_windowDeiconified_7 = false;
        }
        else
    ...
    boolean entered_windowGainedFocus_8;

    public void windowGainedFocus( java.awt.event.WindowEvent e ) {
        if ( !entered_windowGainedFocus_8 ) {
            entered_windowGainedFocus_8 = true;
            __windowGainedFocus( __swiftObject, e);
            entered_windowGainedFocus_8 = false;
        }
        else
    ...
    boolean entered_windowIconified_9;

    public void windowIconified( java.awt.event.WindowEvent e ) {
        if ( !entered_windowIconified_9 ) {
            entered_windowIconified_9 = true;
            __windowIconified( __swiftObject, e);
            entered_windowIconified_9 = false;
        }
        else
    ...
    boolean entered_windowLostFocus_10;

    public void windowLostFocus( java.awt.event.WindowEvent e ) {
        if ( !entered_windowLostFocus_10 ) {
            entered_windowLostFocus_10 = true;
            __windowLostFocus( __swiftObject, e);
            entered_windowLostFocus_10 = false;
        }
        else
    ...
    boolean entered_windowOpened_11;

    public void windowOpened( java.awt.event.WindowEvent e ) {
        if ( !entered_windowOpened_11 ) {
            entered_windowOpened_11 = true;
            __windowOpened( __swiftObject, e);
            entered_windowOpened_11 = false;
        }
        else
    ...
    boolean entered_windowStateChanged_12;

    public void windowStateChanged( java.awt.event.WindowEvent e ) {
        if ( !entered_windowStateChanged_12 ) {
            entered_windowStateChanged_12 = true;
            __windowStateChanged( __swiftObject, e);
            entered_windowStateChanged_12 = false;
        }
        else
