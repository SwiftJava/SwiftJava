...
public class ComponentAdapterProxy extends java.awt.event.ComponentAdapter {
    ...
    boolean entered_componentHidden_0;

    public void componentHidden( java.awt.event.ComponentEvent e ) {
        if ( !entered_componentHidden_0 ) {
            entered_componentHidden_0 = true;
            __componentHidden( __swiftObject, e);
            entered_componentHidden_0 = false;
        }
        else
    ...
    boolean entered_componentResized_2;

    public void componentResized( java.awt.event.ComponentEvent e ) {
        if ( !entered_componentResized_2 ) {
            entered_componentResized_2 = true;
            __componentResized( __swiftObject, e);
            entered_componentResized_2 = false;
        }
        else
    ...
    boolean entered_componentShown_3;

    public void componentShown( java.awt.event.ComponentEvent e ) {
        if ( !entered_componentShown_3 ) {
            entered_componentShown_3 = true;
            __componentShown( __swiftObject, e);
            entered_componentShown_3 = false;
        }
        else
    ...
    boolean entered_toString_6;

    public java.lang.String toString() {
        if ( !entered_toString_6 ) {
            entered_toString_6 = true;
            java.lang.String __return = __toString( __swiftObject );
            entered_toString_6 = false;
            return __return;
        }
        else
