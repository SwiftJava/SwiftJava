...
public class InternalFrameAdapterProxy extends javax.swing.event.InternalFrameAdapter {
    ...
    boolean entered_internalFrameActivated_2;

    public void internalFrameActivated( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameActivated_2 ) {
            entered_internalFrameActivated_2 = true;
            __internalFrameActivated( __swiftObject, e);
            entered_internalFrameActivated_2 = false;
        }
        else
    ...
    boolean entered_internalFrameClosed_3;

    public void internalFrameClosed( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameClosed_3 ) {
            entered_internalFrameClosed_3 = true;
            __internalFrameClosed( __swiftObject, e);
            entered_internalFrameClosed_3 = false;
        }
        else
    ...
    boolean entered_internalFrameClosing_4;

    public void internalFrameClosing( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameClosing_4 ) {
            entered_internalFrameClosing_4 = true;
            __internalFrameClosing( __swiftObject, e);
            entered_internalFrameClosing_4 = false;
        }
        else
    ...
    boolean entered_internalFrameDeactivated_5;

    public void internalFrameDeactivated( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameDeactivated_5 ) {
            entered_internalFrameDeactivated_5 = true;
            __internalFrameDeactivated( __swiftObject, e);
            entered_internalFrameDeactivated_5 = false;
        }
        else
    ...
    boolean entered_internalFrameDeiconified_6;

    public void internalFrameDeiconified( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameDeiconified_6 ) {
            entered_internalFrameDeiconified_6 = true;
            __internalFrameDeiconified( __swiftObject, e);
            entered_internalFrameDeiconified_6 = false;
        }
        else
    ...
    boolean entered_internalFrameIconified_7;

    public void internalFrameIconified( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameIconified_7 ) {
            entered_internalFrameIconified_7 = true;
            __internalFrameIconified( __swiftObject, e);
            entered_internalFrameIconified_7 = false;
        }
        else
    ...
    boolean entered_internalFrameOpened_8;

    public void internalFrameOpened( javax.swing.event.InternalFrameEvent e ) {
        if ( !entered_internalFrameOpened_8 ) {
            entered_internalFrameOpened_8 = true;
            __internalFrameOpened( __swiftObject, e);
            entered_internalFrameOpened_8 = false;
        }
        else
