...
open class SwiftHelloTest_TestResponderImpl: java_lang.JavaObject, SwiftHelloTest_TestListener {
    ...
    open func booleanArrayMethod( arg: [Bool]? ) -> [Bool]! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "booleanArrayMethod", methodSig: "([Z)[Z", methodCache: &SwiftHelloTest_TestResponderImpl.booleanArrayMethod_MethodID_2, args: &__args, locals: &__locals )
