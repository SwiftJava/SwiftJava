...
open class SwiftHello_ResponderForward: JNIObjectForward, SwiftHello_Responder {
    ...
    open func testResponder() -> SwiftHelloTest_TestListener! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "testResponder", methodSig: "()Lcom/jh/SwiftHelloTest$TestListener;", methodCache: &SwiftHello_ResponderForward.testResponder_MethodID_7, args: &__args, locals: &__locals )
    ...
    open func processedNumber( number: Double ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedNumber", methodSig: "(D)V", methodCache: &SwiftHello_ResponderForward.processedNumber_MethodID_8, args: &__args, locals: &__locals )
    }
