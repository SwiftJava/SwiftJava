...
open class SwiftHelloTest_TestListenerForward: JNIObjectForward, SwiftHelloTest_TestListener {
    ...
    private static var booleanArrayMethod_MethodID_28: jmethodID?

    open func booleanArrayMethod( arg: [Bool]? ) -> [Bool]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "booleanArrayMethod", methodSig: "([Z)[Z", methodCache: &SwiftHelloTest_TestListenerForward.booleanArrayMethod_MethodID_28, args: &__args, locals: &__locals )
...
private typealias SwiftHelloTest_TestListener_booleanArrayMethod_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_booleanArrayMethod_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_booleanMethod_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jboolean ) -> jboolean

private func SwiftHelloTest_TestListener_booleanMethod_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jboolean ) -> jboolean {
...
open class SwiftHelloTest_TestListenerBase: JNIObjectProxy, SwiftHelloTest_TestListener {
    ...
    private static let proxyClass: jclass = {
        ...
        natives.append( JNINativeMethod( name: strdup("__booleanArrayMethod"), signature: strdup("([Z)[Z"), fnPtr: unsafeBitCast( SwiftHelloTest_TestListener_booleanArrayMethod_0_thunk, to: UnsafeMutableRawPointer.self ) ) )
    ...
    public required init( javaObject: jobject? ) {
        ...
        createProxy( className: "org/genie/com_jh/SwiftHelloTest_TestListenerProxy", classObject: SwiftHelloTest_TestListenerBase.proxyClass )
    }
