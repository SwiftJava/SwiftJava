...
private typealias SwiftHelloTest_TestListener_byte2dArrayMethod_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_byte2dArrayMethod_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_booleanArrayMethod_3_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_booleanArrayMethod_3( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_boolean2dArrayMethod_4_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_boolean2dArrayMethod_4( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_byteMethod_5_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jbyte ) -> jbyte

private func SwiftHelloTest_TestListener_byteMethod_5( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jbyte ) -> jbyte {
