...
open class SwiftHelloTest_TestListenerForward: JNIObjectForward, SwiftHelloTest_TestListener {
    ...
    private static var boolean2dArrayMethod_MethodID_29: jmethodID?

    open func boolean2dArrayMethod( arg: [[Bool]]? ) -> [[Bool]]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "boolean2dArrayMethod", methodSig: "([[Z)[[Z", methodCache: &SwiftHelloTest_TestListenerForward.boolean2dArrayMethod_MethodID_29, args: &__args, locals: &__locals )
    ...
    private static var byteMethod_MethodID_30: jmethodID?

    open func byteMethod( arg: Int8 ) -> Int8 {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg, locals: &__locals )
        let __return = JNIMethod.CallByteMethod( object: javaObject, methodName: "byteMethod", methodSig: "(B)B", methodCache: &SwiftHelloTest_TestListenerForward.byteMethod_MethodID_30, args: &__args, locals: &__locals )
        return JNIType.decode( type: Int8(), from: __return )
    }
    ...
    private static var booleanMethod_MethodID_31: jmethodID?

    open func booleanMethod( arg: Bool ) -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "booleanMethod", methodSig: "(Z)Z", methodCache: &SwiftHelloTest_TestListenerForward.booleanMethod_MethodID_31, args: &__args, locals: &__locals )
        return JNIType.decode( type: Bool(), from: __return )
    }
    ...
    private static var booleanArrayMethod_MethodID_32: jmethodID?

    open func booleanArrayMethod( arg: [Bool]? ) -> [Bool]! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "booleanArrayMethod", methodSig: "([Z)[Z", methodCache: &SwiftHelloTest_TestListenerForward.booleanArrayMethod_MethodID_32, args: &__args, locals: &__locals )
        return JNIType.decode( type: [Bool](), from: __return )
    }
...
private typealias SwiftHelloTest_TestListener_byteArrayMethod_0_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_byteArrayMethod_0( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_boolean2dArrayMethod_1_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_boolean2dArrayMethod_1( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
private typealias SwiftHelloTest_TestListener_byteMethod_2_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jbyte ) -> jbyte

private func SwiftHelloTest_TestListener_byteMethod_2( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jbyte ) -> jbyte {
...
private typealias SwiftHelloTest_TestListener_booleanMethod_3_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jboolean ) -> jboolean

private func SwiftHelloTest_TestListener_booleanMethod_3( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jboolean ) -> jboolean {
...
private typealias SwiftHelloTest_TestListener_booleanArrayMethod_4_type = @convention(c) ( _: UnsafeMutablePointer<JNIEnv?>, _: jobject?, _: jobject? ) -> jobject?

private func SwiftHelloTest_TestListener_booleanArrayMethod_4( _ __env: UnsafeMutablePointer<JNIEnv?>, _ __this: jobject?, _ arg: jobject? ) -> jobject? {
...
open class SwiftHelloTest_TestListenerBase: JNIObjectProxy, SwiftHelloTest_TestListener {
    ...
    private static func registerNatives() {
        if ( !nativesRegistered ) {
            ...
            natives.append( JNINativeMethod( name: strdup("__boolean2dArrayMethod"), signature: strdup("([[Z)[[Z"), fnPtr: unsafeBitCast( SwiftHelloTest_TestListener_boolean2dArrayMethod_1_thunk, to: UnsafeMutableRawPointer.self ) ) )
            ...
            natives.append( JNINativeMethod( name: strdup("__byteMethod"), signature: strdup("(B)B"), fnPtr: unsafeBitCast( SwiftHelloTest_TestListener_byteMethod_2_thunk, to: UnsafeMutableRawPointer.self ) ) )

            let SwiftHelloTest_TestListener_booleanMethod_3_thunk: SwiftHelloTest_TestListener_booleanMethod_3_type = SwiftHelloTest_TestListener_booleanMethod_3
            natives.append( JNINativeMethod( name: strdup("__booleanMethod"), signature: strdup("(Z)Z"), fnPtr: unsafeBitCast( SwiftHelloTest_TestListener_booleanMethod_3_thunk, to: UnsafeMutableRawPointer.self ) ) )

            let SwiftHelloTest_TestListener_booleanArrayMethod_4_thunk: SwiftHelloTest_TestListener_booleanArrayMethod_4_type = SwiftHelloTest_TestListener_booleanArrayMethod_4
            natives.append( JNINativeMethod( name: strdup("__booleanArrayMethod"), signature: strdup("([Z)[Z"), fnPtr: unsafeBitCast( SwiftHelloTest_TestListener_booleanArrayMethod_4_thunk, to: UnsafeMutableRawPointer.self ) ) )
