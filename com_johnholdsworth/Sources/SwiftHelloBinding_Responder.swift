...
open class SwiftHelloBinding_ResponderForward: JNIObjectForward, SwiftHelloBinding_Responder {
    ...
    private static var processedTextListener_MethodID_12: jmethodID?

    open func processedTextListener( text: SwiftHelloTypes_TextListener? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedTextListener", methodSig: "(Lcom/johnholdsworth/bindings/SwiftHelloTypes$TextListener;)V", methodCache: &SwiftHelloBinding_ResponderForward.processedTextListener_MethodID_12, args: &__args, locals: &__locals )
    }
    ...
    private static var processMapList_MethodID_13: jmethodID?
    ...
    open func processMapList( map: [String:[SwiftHelloTypes_TextListener]]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processMapList", methodSig: "(Lcom/johnholdsworth/bindings/SwiftHelloTypes$ListenerMapList;)V", methodCache: &SwiftHelloBinding_ResponderForward.processMapList_MethodID_13, args: &__args, locals: &__locals )
    }
    ...
    private static var processedText_MethodID_14: jmethodID?

    open func processedText( text: String? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedText", methodSig: "(Ljava/lang/String;)V", methodCache: &SwiftHelloBinding_ResponderForward.processedText_MethodID_14, args: &__args, locals: &__locals )
    }
    ...
    private static var processedNumber_MethodID_15: jmethodID?

    open func processedNumber( number: Double ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: number, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedNumber", methodSig: "(D)V", methodCache: &SwiftHelloBinding_ResponderForward.processedNumber_MethodID_15, args: &__args, locals: &__locals )
    }
    ...
    private static var processedTextListenerArray_MethodID_16: jmethodID?

    open func processedTextListenerArray( text: [SwiftHelloTypes_TextListener]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedTextListenerArray", methodSig: "([Lcom/johnholdsworth/bindings/SwiftHelloTypes$TextListener;)V", methodCache: &SwiftHelloBinding_ResponderForward.processedTextListenerArray_MethodID_16, args: &__args, locals: &__locals )
    }
    ...
    open func processMap( map: [String:SwiftHelloTypes_TextListener]? ) {
        ...
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processMap", methodSig: "(Lcom/johnholdsworth/bindings/SwiftHelloTypes$ListenerMap;)V", methodCache: &SwiftHelloBinding_ResponderForward.processMap_MethodID_17, args: &__args, locals: &__locals )
    }
    ...
    private static var processedTextListener2dArray_MethodID_18: jmethodID?

    open func processedTextListener2dArray( text: [[SwiftHelloTypes_TextListener]]? ) {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: text, locals: &__locals )
        JNIMethod.CallVoidMethod( object: javaObject, methodName: "processedTextListener2dArray", methodSig: "([[Lcom/johnholdsworth/bindings/SwiftHelloTypes$TextListener;)V", methodCache: &SwiftHelloBinding_ResponderForward.processedTextListener2dArray_MethodID_18, args: &__args, locals: &__locals )
    }
