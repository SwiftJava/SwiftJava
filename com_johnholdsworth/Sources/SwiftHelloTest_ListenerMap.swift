...
/// class com.johnholdsworth.bindings.SwiftHelloTest$ListenerMap ///

open class SwiftHelloTest_ListenerMap: java_swift.HashMap {
    ...
    private static var SwiftHelloTest_ListenerMapJNIClass: jclass?
    ...
    /// public com.johnholdsworth.bindings.SwiftHelloTest$ListenerMap()
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "com/johnholdsworth/bindings/SwiftHelloTest$ListenerMap", classCache: &SwiftHelloTest_ListenerMap.SwiftHelloTest_ListenerMapJNIClass, methodSig: "()V", methodCache: &SwiftHelloTest_ListenerMap.new_MethodID_1, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }

    /// public static java.lang.Class com.johnholdsworth.bindings.SwiftHelloTest$ListenerMap.valueClass()
    ...
    open class func valueClass() -> java_swift.JavaClass! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallStaticObjectMethod( className: "com/johnholdsworth/bindings/SwiftHelloTest$ListenerMap", classCache: &SwiftHelloTest_ListenerMapJNIClass, methodName: "valueClass", methodSig: "()Ljava/lang/Class;", methodCache: &valueClass_MethodID_2, args: &__args, locals: &__locals )
